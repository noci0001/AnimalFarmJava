...
public class Donkey extends Animal {
   ...
   // Benjamin Love
   static String[] benLove = {"Skepticism", "Independence", "Tradition", "Justice", "Unity", "Freedom"};
   // Benjamin Hate
   static String[] benHate = {"Deception", "Optimism", "Hypocrisy", "Oppression", "Corruption", "Exploitation"};
   
   public Donkey(String name, String symbolize) {
      ...
      this.personality = new Personality(benLove, benHate);
